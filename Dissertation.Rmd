...
-   TS067 - Highest level of qualification - degree educated
    ...
    Education level data was only included for those people that have degree level education or above. Again, a similar process to calculate the rankings was followed. The number of people in each LSOA that . See Table \ref{tab:dedscr}.
