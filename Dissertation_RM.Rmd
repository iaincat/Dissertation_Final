...
To be able to see clearly, how the zero waste store data scores were distributed, they were plotted as histograms. As figure \ref{fig:zws_scores_hist} shows, the *lsoatotscr* (total scores) were distributed normally between around 15 and 30.
