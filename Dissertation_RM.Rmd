...
Figure fig:min_store_map shows the store that scored the lowest of the 133, with a score of 52. As can be seen in the breakdown of the individual variables average scores, this area scored very low on all factors. This would at first glance suggest that it is not in the best location, however, the area it serves is highly residential
